...
class computeTestScore(Preprocess):
    ...
    """
    def __init__(self, label_cols, do_not_encode_cols, selected_features, train_data, test_data, pred_type, seed, scaler_saved, encoder_saved, label_encoder_saved, printout=False):
    ...
    def pred(self):
        ...
        if self.printout:
            print("X_train_data")
            display(self.X_train_data.head())
            print("X_test_data")
            display(self.X_test_data.head())
